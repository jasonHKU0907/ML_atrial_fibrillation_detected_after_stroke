...
def get_full_eval(y_test, pred_prob, cutoff_list):
    ...
    for cutoff in cutoff_list:
        ...
        nnd = 1/Youden
        evaluations.append(np.round((acc, sens, spec, prec, Youden, f1, auc, apr, nnd), 4))
    evaluations = pd.DataFrame(evaluations)
    evaluations.columns = ['Accuracy', 'Sensitivity', 'Specificity', 'Precision', 'Youden_Index', 'F1_score', 'AUC', 'APR', 'NND']
    return evaluations
